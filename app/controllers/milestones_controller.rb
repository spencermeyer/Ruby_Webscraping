class MilestonesController < ApplicationController
  ...
  private
    ...
    def milestone_params
      params.require(:milestone).permit(:pos, :parkrunner, :time, :age_cat, :age_grade, :gender, :gender_pos, :club, :note, :total, :run_id, :age_grade_position, :age_cat_position, :athlete_number, :integer)
    end
end
